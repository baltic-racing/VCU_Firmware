...
extern uint16_t motor_temp_r;
extern uint16_t inv_temp_r;
extern uint16_t motor_temp_l;
extern uint16_t inv_temp_l;
...
extern uint8_t INV_L_INV_Motor_fault[8];
extern uint8_t INV_R_INV_Motor_fault[8];
extern uint8_t INV_L_AC_DC[8];
